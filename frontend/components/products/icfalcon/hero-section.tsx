...
function GitHubIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 438.549 438.549" className="size-4 shrink-0" fill="currentColor" {...props}>
      <path
...
export function HeroSection() {
  ...
  return (
    <section className="relative flex min-h-[80vh] flex-col items-center justify-center overflow-hidden border-b border-border/60 bg-background px-4 py-16 text-center">
      <Particles
      ...
      <div className="relative z-10 mx-auto max-w-4xl space-y-8">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-extrabold tracking-tight bg-linear-to-b from-foreground via-foreground/90 to-foreground/45 bg-clip-text text-transparent sm:text-5xl md:text-6xl">
            {t("title")}
          </h1>
        ...
        <div className="mx-auto flex flex-col items-center space-y-3">
          ...
          <div className="relative mx-auto flex w-full max-w-md items-center justify-between gap-3 rounded-xl border border-border/60 bg-card/80 px-4 py-2.5 shadow-sm backdrop-blur-xs">
            <ShineBorder
              ...
              duration={12}
            />
            <span className="font-mono text-xs sm:text-sm text-foreground select-all tracking-tight">
              {command}
            </span>
            <Button
              variant="ghost"
