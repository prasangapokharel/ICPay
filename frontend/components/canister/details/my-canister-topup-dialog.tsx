      ...
      >
        <DialogContent className="sm:max-w-md">
          <DialogHeader className="gap-2">
            ...
            <div>
              <DialogTitle className="text-lg font-semibold">{t("topUpTitle")}</DialogTitle>
          ...
          <div className="space-y-4 py-2">
            ...
            {amountError ? (
              ...
              <div className="rounded-2xl border border-border/60 bg-muted/25 px-4 py-3.5">
                ...
                <p className="mt-1 text-2xl font-bold tracking-tight tabular-nums text-foreground sm:text-3xl">
