...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-4xl p-[3px] text-muted-foreground group-data-horizontal/tabs:h-9 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col group-data-vertical/tabs:rounded-2xl data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default: "bg-muted",
        line: "h-8 gap-4 rounded-none bg-transparent p-0",
        outline: "gap-0.5 rounded-xl bg-transparent ring-1 ring-border",
      },
    },
    defaultVariants: {
      variant: "default",
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "group-data-[variant=outline]/tabs-list:rounded-lg group-data-[variant=outline]/tabs-list:border group-data-[variant=outline]/tabs-list:border-transparent group-data-[variant=outline]/tabs-list:data-active:border-input group-data-[variant=outline]/tabs-list:data-active:bg-transparent dark:group-data-[variant=outline]/tabs-list:data-active:border-input dark:group-data-[variant=outline]/tabs-list:data-active:bg-transparent",
