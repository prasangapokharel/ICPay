...
run_test "$ROOT/testing/services/AnalyticsService.test.mo" "AnalyticsService"
...
run_test "$ROOT/testing/services/TokenCustody.test.mo" "TokenCustody"
...
run_test "$ROOT/testing/services/IcCommunityService.test.mo" "IcCommunityService"
run_test "$ROOT/testing/services/SocialLinkService.test.mo" "SocialLinkService"
run_test "$ROOT/testing/services/SaleService.test.mo" "SaleService"
run_test "$ROOT/testing/services/TradeService.test.mo" "TradeService"
...
run_test "$ROOT/testing/upgrade/AddBucketFolders.test.mo" "AddBucketFolders"
run_test "$ROOT/testing/upgrade/AddCommunityChannelAvatar.test.mo" "AddCommunityChannelAvatar"
run_test "$ROOT/testing/upgrade/MoveBucketBlobData.test.mo" "MoveBucketBlobData"
run_test "$ROOT/testing/upgrade/DropLegacyBlobStore.test.mo" "DropLegacyBlobStore"
run_test "$ROOT/testing/upgrade/DropMotokoSwap.test.mo" "DropMotokoSwap"
...
run_test "$ROOT/testing/security/Sale.test.mo" "SaleSecurity"
